...
const Achievements = () => {
  const achievements = [
    ...
    },
    {
      ...
      items: [
        "Top 5% in Red Hat System Admin (2024)",
        "Google Gen AI goodies recipient",
    ...
    },
    {
      ...
      items: [
        "Python, Cybersecurity, Data Science (Cisco)",
        "Red Hat Certified System Administrator (RHCSA)",
        "Cisco Certified Network Associate (CCNA)",
        "IIT KGP Cloud & IoT Certification"
      ],
      icon: "📜",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {certifications.map((cert, index) => (
              <div
                key={index}
                className="glass-effect p-4 rounded-lg text-center hover:glow-effect transition-all duration-300 group cursor-default"
              >
                <div className="w-8 h-8 bg-gradient-to-r from-tech-blue to-tech-teal rounded-full mx-auto mb-2 group-hover:scale-110 transition-transform duration-300"></div>
